...
class ResNet(nn.Module):
    def __init__(self, block, filters, layers, num_classes=10):
        self.inplanes = filters[0]
        super(ResNet, self).__init__()
        self.conv1 = nn.Conv2d(1, filters[0], kernel_size=3, stride=1, padding=1,
                               bias=False)
...
def resnet14(org= False, **kwargs):
    ...
    model = ResNet(BasicBlock, filters, [2, 2, 2], **kwargs)
